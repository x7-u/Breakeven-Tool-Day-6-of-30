...
![Local-only](https://img.shields.io/badge/Hosted-Local_only_(127.0.0.1:1006)-555555?style=flat-square)
![Status](https://img.shields.io/badge/Status-MVP_complete-16A34A?style=flat-square)

Cost-volume-profit modelling with a sensitivity heatmap, industry-benchmark comparisons, Monte Carlo on the unit economics, plus an AI brief that translates the chart into a one-paragraph operating recommendation.

This is **Day 06 of a 30-day finance and AI portfolio sprint** where each
...
- **Model**: DeepSeek V4 (via the OpenAI SDK).
- **Cost target**: around $0.0005 per analysis.
...
A browser window opens at `http://127.0.0.1:1006/`.
...
- Python 3.11+
- openai (DeepSeek client), reportlab + python-pptx, openpyxl, matplotlib, numpy, flask
...
day-06-breakeven-tool/
  server.py            Flask web server (port 1006)
...
Safwan Ahmed. Day 06 of the 30-day finance + AI sprint, 2026.
